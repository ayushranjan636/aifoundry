...
export const MODEL_OPTIONS: ModelOption[] = [
  ...
  },
  {
    ...
    fitScore: 82,
    recommended: false,
    description: 'Open-weight model with wide community support and strong general capabilities.',
    capabilities: ['Open weights', 'Strong reasoning', 'Broad task coverage', 'Community ecosystem'],
    costIndicator: 'low',
    speedIndicator: 'medium',
    deploymentComplexity: 'simple',
    useCases: ['General tasks', 'RAG systems', 'Instruction following'],
    parameters: '8B / 70B',
  },
  {
    id: 'mistral',
    ...
    fitScore: 78,
    recommended: false,
    description: 'Efficient European model with strong code and structured output capabilities.',
    capabilities: ['Efficient architecture', 'Code generation', 'Structured output', 'European deployment'],
    costIndicator: 'low',
    speedIndicator: 'fast',
    deploymentComplexity: 'simple',
    useCases: ['Code tasks', 'Structured extraction', 'European data residency'],
    parameters: '7B / 8x7B',
  },
  {
    id: 'gemma',
    ...
    fitScore: 71,
    recommended: false,
    description: 'Lightweight Google model optimized for on-device and resource-constrained deployments.',
    capabilities: ['Lightweight', 'On-device', 'Instruction-tuned', 'Google ecosystem'],
    costIndicator: 'low',
    speedIndicator: 'fast',
    deploymentComplexity: 'simple',
    useCases: ['Edge deployment', 'Resource-constrained', 'Simple classification'],
    parameters: '2B / 7B',
  },
  {
    id: 'deepseek',
  ...
  },
  {
    ...
    fitScore: 63,
    recommended: false,
    description: 'Managed cloud model. Best when you need maximum reliability with zero self-hosting effort.',
    capabilities: ['Managed infrastructure', 'Strong reasoning', 'Wide capability', 'Zero ops'],
    costIndicator: 'high',
    speedIndicator: 'medium',
    deploymentComplexity: 'simple',
    useCases: ['API-first deployments', 'General applications', 'When data privacy is flexible'],
    parameters: 'API only',
  },
];
